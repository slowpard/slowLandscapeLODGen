    ...
    while True:
        ...
        if cfg.general.generate_color_maps:
            ...
            def GenerateTextureMaps(texture_id_map, opacity_map, vertex_color_map, file_name, folder, ao_data):
                ...
                output_texture = generate_full_texture_layer(output_texture, ltex_to_texture_hashed, distance_matrix_central, (0+31, 0+31), PRECALCULATED_TILING_DATA, PRECALCULATED_TRIANGLE_WEIGHTS, texture_id_map, opacity_map, vertex_color_map, textures_nparray, textures_nparray_avg, textures_nparray_alpha, cfg.texture.chunk_dim)
                output_texture = generate_full_texture_layer(output_texture, ltex_to_texture_hashed, distance_matrix_N, (0+31, 1+31), PRECALCULATED_TILING_DATA, PRECALCULATED_TRIANGLE_WEIGHTS, texture_id_map, opacity_map, vertex_color_map, textures_nparray, textures_nparray_avg, textures_nparray_alpha, cfg.texture.chunk_dim)
                output_texture = generate_full_texture_layer(output_texture, ltex_to_texture_hashed, distance_matrix_S, (0+31, -1+31), PRECALCULATED_TILING_DATA, PRECALCULATED_TRIANGLE_WEIGHTS, texture_id_map, opacity_map, vertex_color_map, textures_nparray, textures_nparray_avg, textures_nparray_alpha, cfg.texture.chunk_dim)
                output_texture = generate_full_texture_layer(output_texture, ltex_to_texture_hashed, distance_matrix_E, (1+31, 0+31), PRECALCULATED_TILING_DATA, PRECALCULATED_TRIANGLE_WEIGHTS, texture_id_map, opacity_map, vertex_color_map, textures_nparray, textures_nparray_avg, textures_nparray_alpha, cfg.texture.chunk_dim)
                output_texture = generate_full_texture_layer(output_texture, ltex_to_texture_hashed, distance_matrix_W, (-1+31, 0+31), PRECALCULATED_TILING_DATA, PRECALCULATED_TRIANGLE_WEIGHTS, texture_id_map, opacity_map, vertex_color_map, textures_nparray, textures_nparray_avg, textures_nparray_alpha, cfg.texture.chunk_dim)
                output_texture = generate_full_texture_layer(output_texture, ltex_to_texture_hashed, distance_matrix_NE, (1+31, 1+31), PRECALCULATED_TILING_DATA, PRECALCULATED_TRIANGLE_WEIGHTS, texture_id_map, opacity_map, vertex_color_map, textures_nparray, textures_nparray_avg, textures_nparray_alpha, cfg.texture.chunk_dim)
                output_texture = generate_full_texture_layer(output_texture, ltex_to_texture_hashed, distance_matrix_NW, (-1+31, 1+31), PRECALCULATED_TILING_DATA, PRECALCULATED_TRIANGLE_WEIGHTS, texture_id_map, opacity_map, vertex_color_map, textures_nparray, textures_nparray_avg, textures_nparray_alpha, cfg.texture.chunk_dim)
                output_texture = generate_full_texture_layer(output_texture, ltex_to_texture_hashed, distance_matrix_SE, (1+31, -1+31), PRECALCULATED_TILING_DATA, PRECALCULATED_TRIANGLE_WEIGHTS, texture_id_map, opacity_map, vertex_color_map, textures_nparray, textures_nparray_avg, textures_nparray_alpha, cfg.texture.chunk_dim)
                output_texture = generate_full_texture_layer(output_texture, ltex_to_texture_hashed, distance_matrix_SW, (-1+31, -1+31), PRECALCULATED_TILING_DATA, PRECALCULATED_TRIANGLE_WEIGHTS, texture_id_map, opacity_map, vertex_color_map, textures_nparray, textures_nparray_avg, textures_nparray_alpha, cfg.texture.chunk_dim)
